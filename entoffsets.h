...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_nSequenceViewmodel;
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bDucked;
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > moveparent;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > coordinate_frame;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flModelScale;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_ScaleType;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR(m_nSequenceViewmodel,          HASH("DT_PredictedViewModel"), HASH("m_nSequence"));
        ...
        INIT_XOREDNETVAR(m_fAccuracyPenalty, HASH("DT_WeaponCSBase"), HASH("m_fAccuracyPenalty"));
        ...
        INIT_XOREDNETVAR(m_vecBaseVelocity, HASH("DT_BasePlayer"), HASH("m_vecBaseVelocity"));
        ...
        INIT_XOREDNETVAR(m_bDucked, HASH("DT_BasePlayer"), HASH("m_bDucked"));
        INIT_XOREDNETVAR(m_nNextThinkTick, HASH("DT_BasePlayer"), HASH("m_nNextThinkTick"));
        INIT_XOREDNETVAR(m_hViewModel, HASH("DT_CSPlayer"), HASH("m_hViewModel[0]"));
        INIT_XOREDNETVAR(m_nAnimationParity, HASH("DT_BaseViewModel"), HASH("m_nAnimationParity"));
        INIT_XOREDNETVAR(m_flAnimTime, HASH("DT_BaseEntity"), HASH("m_flAnimTime"));
        INIT_XOREDNETVAR(m_flStepSize, HASH("DT_CSPlayer"), HASH("m_flStepSize"));
        INIT_XOREDNETVAR(moveparent, HASH("DT_BaseEntity"), HASH("moveparent"));
        ...
        INIT_XOREDNETVAR(m_ScaleType, HASH("DT_BaseAnimating"), HASH("m_ScaleType"));
        ...
        INIT_XOREDNETVAR_SPECIFIC(coordinate_frame, g_netvars.get(HASH("DT_BaseEntity"), HASH("m_CollisionGroup")) - 0x30);
