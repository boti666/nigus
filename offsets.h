...
namespace offsets
{
	...
	constexpr uint64_t interface_client = 0x5f950a0a0560036a; //0x18275473
	constexpr uint64_t interface_entity_list = 0x6c385bd2d88bd9c5; //0x18275470
	constexpr uint64_t interface_engine = 0x6440607e874b5eb3; //0x18275471
	constexpr uint64_t interface_prediction = 0x26a97ec0330f7222; //0x18275476
	constexpr uint64_t interface_move_helper = 0x8f4a73c10c6d7685;
	constexpr uint64_t interface_game_movement = 0xd75d1bef22ec48c8; //0x18275474
	constexpr uint64_t interface_globals = 0xf77913ecbf0799f7; //0x18275475
	constexpr uint64_t interface_model_info = 0xe6cac7b268d12498; //0x1827547A
	constexpr uint64_t interface_model_render = 0xe3e936ce84c3f44e; //0x1827547B
	constexpr uint64_t interface_material_system = 0x3ad18acae725dcd7; //0x18275478
	constexpr uint64_t interface_render_view = 0x790f9909e89adcc9; //0x18275479
	constexpr uint64_t interface_cvar = 0x8f55ff2c8ef0f083; //0x1827547E
	constexpr uint64_t interface_view_render = 0xabbccb3b25744fd8; //0x1827547F
	constexpr uint64_t interface_view_render_beams = 0xed2603870adc719a; //0x1827547C
	constexpr uint64_t interface_game_event_manager = 0x6f1b5aa7eac0ad9e; //0x1827547D
	constexpr uint64_t interface_input = 0xde6f3f4e7cb943e9; //0x18275462
	constexpr uint64_t interface_surface_props = 0x8c0d532171b8ac9a; //0x18275463
	constexpr uint64_t interface_engine_trace = 0x87f54b60cdea5ada; //0x18275460
	constexpr uint64_t interface_client_state = 0x5fbe0848b92abfcb; //0x18275461
	constexpr uint64_t interface_surface = 0x19ba827c7ff8863a; //0x18275466
	constexpr uint64_t interface_memalloc = 0xc6f89eb3ec46f297; //0x18275467
	constexpr uint64_t interface_debug_overlay = 0x9c0d656b67373e7c; //0x18275464
	constexpr uint64_t interface_glow_object_manager = 0xffded58a3e715e8e; //0x18275465
	constexpr uint64_t interface_panel = 0x52b684df3ee66e63; //0x1827546A
	constexpr uint64_t interface_engine_sound = 0x45aa27a005c9606d;
	constexpr uint64_t interface_game_rules_proxy = 0xfbd1b1bb5794d9e5; //0x18275468
	constexpr uint64_t interface_weapon_system = 0x2b0da6691ef7f97d; //0x18275469
	constexpr uint64_t interface_inventory_manager = 0xe8f710a554722fe;
	constexpr uint64_t interface_localize = 0x83f31d18385fe68c; //0x1827546F
	constexpr uint64_t interface_hud = 0x8de9a3e3a6a72b7e; //0x1827546C
	constexpr uint64_t interface_player_resource = 0x836ed98ce95780fb; //0x1827546D
	constexpr uint64_t interface_client_leaf_system = 0xfaad2edafb3c7264; //0x18275452
	constexpr uint64_t interface_effects = 0x20750c86c25e7925;
	constexpr uint64_t interface_host_state = 0x7599ce1a802f7235;
	constexpr uint64_t interface_mdl_cache = 0x666b408ce30f4ba0; //0x18275451
	constexpr uint64_t interface_studio_render = 0xcf8a4047a0511531; //0x18275456
	constexpr uint64_t interface_hardware_config = 0xc52b5fcd0241f48e; //0x18275457
	constexpr uint64_t interface_client_tools = 0x56771e6c7138dac6;
	constexpr uint64_t interface_string_tables = 0x5c84e591d81ed4b1; //0x18275455
	constexpr uint64_t interface_file_system = 0x2a8ad007a599b0e3;
	constexpr uint64_t interface_key_values_system = 0x3262ce91de15d0a3; //0x1827545B
	constexpr uint64_t interface_panoroama_ui_engine = 0x78e66385c86c032d; //0x18275458
	constexpr uint64_t sig_set_abs_angles = 0xc3a1d32bd7bc089f; //0x18275459
	constexpr uint64_t sig_set_abs_origin = 0xf5fed60f6dae2aec;
	constexpr uint64_t sig_update_anim_state = 0x36e25bd40f58fb9; //0x1827545F
	constexpr uint64_t sig_ret_to_cam_think = 0x8e46e062503f02c0; //0x1827545C
	constexpr uint64_t sig_ret_to_draw_notify = 0xc42fd79f8a3030ed; //0x1827545D
	constexpr uint64_t sig_ret_to_console_print = 0xff1351fa85fcf389; //0x18275442
	constexpr uint64_t sig_ret_to_add_notify = 0x3e5770e2b6a9782d; //0x18275443
	constexpr uint64_t sig_ret_to_draw_crosshair = 0xf4d2f297ceea4d75; //0x18275440
	constexpr uint64_t sig_standard_blending_rules = 0xd84a911417dc07f2; //0x18275441
	constexpr uint64_t sig_build_transformations = 0x46ff1c838276703c;
	constexpr uint64_t sig_smoke_count = 0x6f2142ec80907bd4; //0x18275447
	constexpr uint64_t sig_get_econ_item_view = 0xde09f047f2c0b3c3; //0x1827544F
	constexpr uint64_t sig_get_sequence_act = 0x7407bc9d7fb27df9; //0x18275445
	constexpr uint64_t sig_invalidate_physics_recursive = 0xe8d207d9e93c6229;
	constexpr uint64_t sig_is_breakable_entity = 0x3928934de0ad2a4c; //0x1827544B
	constexpr uint64_t sig_print_dev_console = 0xbe3564b890efde15; //0x18275448
	constexpr uint64_t sig_find_element = 0xd157c3edd38d6d89; //0x18275449
	constexpr uint64_t sig_physics_run_think = 0xbe65f44bb17d2246;
	constexpr uint64_t sig_cmbat_get_econ_item_view = 0xa41fb05fec6f9341; //0x1827544F
	constexpr uint64_t sig_get_static_data = 0xffd223aaf2c70828; //0x1827544C
	constexpr uint64_t sig_disable_post_processing = 0x7db4e75e9fb4d408; //0x1827544D
	constexpr uint64_t sig_gc_client_system = 0xecaa3a90ab162975;
	constexpr uint64_t sig_lookup_bone = 0xccce944e870e9f67; //0x18275433
	constexpr uint64_t sig_modifier_table = 0x24abb75efb6b789a; //0x18275430
	constexpr uint64_t sig_load_named_sky = 0x7cc3509ae525c10a; //0x18275431
	constexpr uint64_t sig_reveal_ranks = 0x490096b3c2ac0f82; //0x18275436
	constexpr uint64_t sig_set_clantag = 0x64ede7812291d2bc; //0x18275437
	constexpr uint64_t sig_deathnotice_check = 0x94dec95c061ed333; //0x18275434
	constexpr uint64_t sig_clear_deathnotices = 0x2dbdf37b105eff46; //0x18275435
	constexpr uint64_t sig_get_checksum = 0x2b235adcef40a112; //0x1827543A
	constexpr uint64_t sig_equip_glove = 0x1f34daea4358b3d9; //0x1827543B
	...
	constexpr uint64_t sig_cl_send_move_limit = 0xc1d50290b89296c2; //0x1827543F
	constexpr uint64_t sig_is_ready = 0x844414dc8356c216; //0x1827543C
	constexpr uint64_t sig_ret_to_setup_velocity = 0xc278b4f361afaf1a; //0x1827543D
	constexpr uint64_t sig_ret_to_post_data_update = 0x5cd9aa960a71db6d;
	constexpr uint64_t sig_ret_to_enable_inventory = 0xf57ee058e58d2fb6; //0x18275423
	constexpr uint64_t sig_interp_clamp = 0xfb2fdd26bb7ac499; //0x18275420
	constexpr uint64_t sig_ret_to_trace_ray = 0xc42fea95e1cb2027; //0x18275421
	constexpr uint64_t sig_ret_to_scope_arc = 0xde35d7f551feffe9; //0x18275426
	constexpr uint64_t sig_ret_to_scope_lens = 0x80bc033e976bb530; //0x18275427
	constexpr uint64_t sig_post_process_params = 0x8a472a02d278a631; //0x18275424
	constexpr uint64_t sig_ret_to_post_network_data_received = 0x2d63be60ef1d8558; //0x18275425
	constexpr uint64_t sig_ret_to_add_viewmodel_stattrak = 0x6a6162f1877ad02a; //0x1827542A
	constexpr uint64_t sig_trace_to_studio_csgo_hitgroups_priority = 0x2a02701bea9446a4; //0x1827542B
	constexpr uint64_t sig_should_skip_anim_frame_check = 0xaaf12770a9c49139;
	constexpr uint64_t sig_somelimit = 0x553941c275e33fe7; //0x18275429
	constexpr uint64_t sig_cvar_check = 0xedbda6235255216d; //0x1827542E
	constexpr uint64_t sig_cs_player_pred_map = 0x9adff1132c3cedb0; //0x1827542F
	constexpr uint64_t sig_base_cs_grenade_pred_map = 0x4f4704cac49e99fa; //0x1827542C
	constexpr uint64_t sig_decoy_map = 0xa9d819157ae0fdf2; //0x1827542D
	constexpr uint64_t sig_he_map = 0x23c2b09661bca9d6; //0x18275412
	constexpr uint64_t sig_molotov_map = 0xd7807f9e1e2a11cf; //0x18275413
	constexpr uint64_t sig_sensor_map = 0x706ab8580377a0a5; //0x18275410
	constexpr uint64_t sig_smoke_map = 0x4bdd967cd08c857b; //0x18275411
	constexpr uint64_t sig_flash_map = 0x3fd82477752d9151; //0x18275416
	constexpr uint64_t sig_view_matrix = 0x7378065c760cfc52; //0x18275417
	...
	constexpr uint64_t sig_animstate_reset = 0x7a080929481d0ba2; //0x1827541B
	constexpr uint64_t sig_update_layer_order_preset = 0xd3928a0a815258ef; //0x18275418
	...
	constexpr uint64_t sig_empty_mapping = 0xd6dbb55482a20627; //0x1827541D
	constexpr uint64_t sig_simulation_tick = 0x8af4a3de0e05db60; //0x18275402
	constexpr uint64_t sig_predictable = 0x1e735fa66949f69c; //0x18275403
	constexpr uint64_t sig_custom_materials = 0x82ed461e41517960; //0x18275400
	constexpr uint64_t sig_custom_material_initialized = 0xd5797cf7bbf4e6b9; //0x18275401
	constexpr uint64_t sig_visual_data_processors = 0x365df4bdd74f8f9e; //0x18275406
	constexpr uint64_t sig_spawn_time = 0x36d78d396680029c; //0x18275407
	constexpr uint64_t sig_ragdoll = 0x28e7810d44232948; //0x182754DD
	constexpr uint64_t sig_lod_data = 0xacbf4f14183d0c92; //0x18275405
	constexpr uint64_t sig_ik_context = 0x1aaa2f9406552861; //0x1827540A
	constexpr uint64_t sig_snapshot_front = 0x97e44daeccdc4637; //0x1827540B
	constexpr uint64_t sig_snapshot_back = 0x4a0399fdee6b65d7; //0x18275408
	constexpr uint64_t sig_blend_tick = 0xda223f6932869407; //0x18275409
	constexpr uint64_t sig_get_follow_entity = 0xba7e6a572cb1fd93;
	constexpr uint64_t sig_last_client_fire_bullet_time = 0x8fef906073f3f319; //0x1827540F
	constexpr uint64_t sig_final_predicted_tick = 0xc293e4b7c6f0b202; //0x1827540C
	constexpr uint64_t sig_occlusion_mask = 0x9ed793f6cc4430ee; //0x18275512
	constexpr uint64_t sig_anim_state = 0xe5eaa2bd622a212b; //0x182754F2
	constexpr uint64_t sig_command_context = 0xa50337dc518ac966; //0x182754F3
	constexpr uint64_t sig_send_matching_sequence = 0x2ed0be876534ef26;
	constexpr uint64_t sig_sound_channels = 0xaed9917e2d919803;
	constexpr uint64_t sig_activity_mapping = 0x7fb7c0f4aa8e9e42; //0x182754F6
	constexpr uint64_t sig_load_from_buffer = 0x13947a2831c37f5a; //0x182754F7
	constexpr uint64_t sig_modifier_table_find = 0x9bffcda77c63d82a; //0x182754F4
	constexpr uint64_t sig_modifier_table_add_string = 0x8bfc485169ebedb; //0x182754F5
	constexpr uint64_t sig_allocate_thread_id = 0xebbe2b099bac1649; //0x182754FA
	constexpr uint64_t sig_game_tonemap_settings = 0xa258d7a07d4b2677;
	constexpr uint64_t sig_length_disasm_game = 0x75a00 ^ 0xfc01c181da864751 ^ 2166136261;
	constexpr uint64_t sig_get_active_weapon_prefix = 0x3c6f262f8862b3f0; //0x182754F9
	constexpr uint64_t sig_get_layer_ideal_weight_from_sequence_cycle = 0x88f12f1cb5bcfe2e;
	constexpr uint64_t sig_on_simulation_time_changing = 0x25b320b6906c5a7e; //0x182754FF
	constexpr uint64_t sig_get_root_move_parent = 0x20da1a15cd67abd0;
	constexpr uint64_t sig_ik_context_construct = 0xe1285122e4d32fe7; //0x182754FD
	constexpr uint64_t sig_ik_context_destruct = 0x11534a46a7661f25; //0x182754E2
	constexpr uint64_t sig_ik_context_init = 0xb2c61463d7f39caf; //0x182754E3
	constexpr uint64_t sig_ik_context_update_targets = 0x4243e94ec7d10f48; //0x182754E0
	constexpr uint64_t sig_ik_context_solve_dependencies = 0x55c1dbb9af7ced49; //0x182754E1
	constexpr uint64_t sig_allocate_and_merge_bones = 0xb21b578e0aaea1fb;
	constexpr uint64_t sig_lookup_sequence = 0x1c4a557c1afa7682; //0x182754E7
	constexpr uint64_t sig_ammodef_get = 0xefc47e99011658ab; //0x182754E4
	...
	constexpr uint64_t sig_process_sockets = 0x3a655f43371e14f2; //0x182754EB
	constexpr uint64_t sig_sequence_hash_find_hash = 0xfd495a1c92349968; //0x182754E8
	constexpr uint64_t sig_activity_mapping_reinitialize = 0x6a268ae97cfcd679; //0x182754E9
	constexpr uint64_t sig_find_mapping = 0x79ff80b3818739de; //0x182754EE
	constexpr uint64_t sig_index_model_sequences = 0x5702b8e6ad354621; //0x182754EF
	constexpr uint64_t sig_get_seq_desc = 0x39d0a0 ^ static_cast<uint64_t>(randomized_hash::sig_get_seq_desc) ^ 2166136261u;;
	constexpr uint64_t sig_keyvalues_init = 0xdcb56c67431e0f43; //0x182754ED
	constexpr uint64_t sig_ret_is_box_visible = 0x20cb2176c901ba72; //0x182754D2
	constexpr uint64_t sig_random_int = 0x6485da387fa70f9a; //0x182754D3
	constexpr uint64_t sig_random_float = 0x9f28ebb1c1f009d1; //0x182754D0
	constexpr uint64_t sig_random_seed = 0xa9d0ca2aa104428b; //0x182754D1
	constexpr uint64_t sig_var_mapping = 0x23f8ce10532a2ecd; //0x182754D6
	constexpr uint64_t sig_free_thread_id = 0x368a7026fcdf541f; //0x182754D7
	constexpr uint64_t sig_tls_slots = 0xb7ff556d7edf6ef8; //0x182754D4
	constexpr uint64_t sig_projectile_throwtime = 0x271b6c0e2c60e5e6; //0x1827579E
	constexpr uint64_t sig_init_materials = 0x4a5eccce6ab81636; //0x182754DA
	constexpr uint64_t sig_render_box = 0xe5e5361cbbc158be; //0x182754DB
	constexpr uint64_t sig_render_triangle = 0x4084b1f52e5a03b1;
	constexpr uint64_t sig_vertex_color_ignorez = 0x421ad52fa6ad1d3e; //0x182754D9
	constexpr uint64_t sig_cycle_offset = 0x99e1e9f68a387c13; //0x182755F6
	constexpr uint64_t sig_studio_hdr = 0x563bb319e81e2b5e; //0x182754DF
	constexpr uint64_t sig_anim_layers = 0x9665292c350da9cf; //0x182754DC
	constexpr uint64_t sig_is_ragdoll = 0x70a6503e73895f47; //0x182754DD
	constexpr uint64_t sig_bone_accessor = 0xeb3755e63bc588cf; //0x182754C2
	constexpr uint64_t sig_cl_move_rest = 0xf41f9195e5a4a5d5; //0x182754C3
	constexpr uint64_t sig_post_build_transformations = 0xa5d317be05c73e98; //0x182754C0
	constexpr uint64_t sig_ret_to_post_build_transformations = 0xf7e51cb5d3a301c9;
	constexpr uint64_t sig_collision_viewheight = 0xae612a2ac926698e; //0x182754C6
	constexpr uint64_t sig_collision_bounds_change_time = 0x6c4d1697ebe311bc; //0x182754C7
	constexpr uint64_t sig_velocity_patch = 0xcf3a383100b892c4;
	constexpr uint64_t sig_kv_find_key = 0x4f9d628d378bc9dc;
	constexpr uint64_t sig_kv_set_string = 0xa4557c28e192e86e; //0x182754CA
	constexpr uint64_t sig_surface_props = 0xffab6bcca7022fc0;
	constexpr uint64_t sig_animstate_update_setabsagles = 0x54fadacfd08552c6; //0x182754C8
	constexpr uint64_t sig_mdl_create = 0x9789a04a47ed8d82; //0x182754C9
	constexpr uint64_t sig_set_merged_mdl = 0x46f1e57a0555d4da; //0x182754CE
	constexpr uint64_t sig_setup_bones_attachment_queries = 0x2ef716a05cc1838; //0x182754CF
	constexpr uint64_t sig_disable_render_target_allocation = 0xad19d20f5dc47300; //0x182754CC
	constexpr uint64_t sig_get_sequence_flags = 0x5a8a09ed34f53102; //0x182754CD
	constexpr uint64_t sig_get_iron_sight_controller = 0x7ebc5344bac80a96; //0x182754B2
	constexpr uint64_t sig_enable_invalidate_bone_cache = 0x85f4cad426f73ebb; //0x182754B3
	constexpr uint64_t sig_line_goes_through_smoke = 0xab4ea08f292f7c36; //0x182754B0
	constexpr uint64_t sig_keyvalues_from_netsmg = 0x4d6c9d4053587bb6; //0x182754B1
	...
	constexpr uint64_t sig_ret_hitbox_to_world_transforms = 0xd944c1fb78f2d004; //0x182754B5
	constexpr uint64_t sig_emit_sound = 0xdf27340985e23ba4; //0x182754BA
	constexpr uint64_t sig_add_to_dirty_kd_tree = 0xa3ed8cb40064b085; //0x182754BB
	constexpr uint64_t sig_get_player_viewmodel_arm_config_for_player_model = 0xeaf555c797db5651; //0x182754B8
	constexpr uint64_t sig_client_side_addons_mask = 0xff4c0d4b3f958c49; //0x182754B9
	constexpr uint64_t sig_assassination_target_addon = 0x42893065b2bd69ca; //0x182754BE
	constexpr uint64_t sig_update_addon_models = 0xd9be6e58a8500964; //0x182754BF
	constexpr uint64_t sig_msg_voicedata_constructor = 0xda3234911b157b58; //0x182754BC
	constexpr uint64_t sig_parse_svg = 0x704eef6d50899593; //0x182754BD
	constexpr uint64_t sig_construct_image = 0x70530363b711fce4; //0x182754A2
	constexpr uint64_t sig_load_text_file = 0xe26232176602d8fc; //0x182754A3
	constexpr uint64_t sig_econ_item_system = 0xa57ad8774ca765fc; //0x182754A0
	constexpr uint64_t sig_clear_hud_weapon_icon = 0x907c4b8bf3a6b3d7; //0x182754A1
	constexpr uint64_t sig_skinchanger_spam_patch = 0xaee4871f0b157c17; //0x182754A6
	constexpr uint64_t sig_cvar_vac_check = 0x5aedb571a8048798; //0x182754A7
	constexpr uint64_t sig_v8_try_catch_ctor = 0x56d1d749879ead0e; //0x182754A4
	constexpr uint64_t sig_v8_try_catch_dtor = 0x1b384287178dbf15; //0x182754A5
	constexpr uint64_t sig_v8_handle_scope_ctor = 0x6c0ada1422807960; //0x182754AA
	constexpr uint64_t sig_v8_handle_scope_dtor = 0x5bdb2735b13d980c; //0x182754AB
	constexpr uint64_t sig_v8_handle_scope_create_handle = 0xddf663355d4b45ca; //0x182754A8
	constexpr uint64_t sig_v8_context_enter = 0x9b878b80cf7325d3; //0x182754A9
	constexpr uint64_t sig_v8_context_exit = 0xdcefdd2c64f6e320; //0x182754AE
	constexpr uint64_t sig_v8_isolate_enter = 0x45f80fe26b4fa648; //0x182754AF
	constexpr uint64_t sig_v8_isolate_exit = 0x6d19cc3d93a89d6c; //0x182754AC
	constexpr uint64_t sig_v8_array_get = 0xd2f263411cd78c2f; //0x182754AD
	constexpr uint64_t sig_v8_array_length = 0xa703567883cd3ecf; //0x18275492
	constexpr uint64_t sig_v8_object_get = 0x7fc0da130bf67f24; //0x18275493
	constexpr uint64_t sig_v8_object_get_property_names = 0xe90245bd2236e62a; //0x18275490
	constexpr uint64_t sig_v8_value_is_boolean = 0xba1a8d48ca5d3d88; //0x18275491
	constexpr uint64_t sig_v8_value_is_boolean_object = 0xd5572bd1d425607e; //0x18275496
	constexpr uint64_t sig_v8_value_is_number = 0xc177fa825ede9b2d; //0x18275497
	constexpr uint64_t sig_v8_value_is_number_object = 0xc696d67e88b00b34; //0x18275494
	constexpr uint64_t sig_v8_value_is_string = 0xfb7c81faecee59bf; //0x18275495
	constexpr uint64_t sig_v8_value_is_string_object = 0xa766d1be9c3ebd58; //0x1827549A
	constexpr uint64_t sig_v8_value_is_object = 0xdb10af33fb398a98; //0x1827549B
	constexpr uint64_t sig_v8_value_is_array = 0xae8c9cb172173fb2; //0x18275498
	constexpr uint64_t sig_v8_value_is_function = 0x320bdf6913d3c0f6; //0x18275491
	constexpr uint64_t sig_v8_value_boolean_value = 0x7e415ee1e064c334; //0x1827549E
	constexpr uint64_t sig_v8_value_number_value = 0xdc4039f8f61692dd; //0x1827549F
	constexpr uint64_t sig_v8_value_to_object = 0x8276c837503ea52; //0x1827549C
	constexpr uint64_t sig_v8_string_utf8_ctor = 0xfad7d6ef77bcdc5a; //0x1827549D
	constexpr uint64_t sig_v8_string_utf8_dtor = 0x15cc74626ce6fc7; //0x18275482
	constexpr uint64_t sig_ui_engine_get_panel_context = 0x4c29beb51b80c9e2; //0x18275483
	constexpr uint64_t sig_ui_engine_compile = 0x22ba178e6144e703; //0x18275480
	constexpr uint64_t sig_ui_engine_run_compiled_script = 0xd5dbbeedd9fc0bc3; //0x18275481
	constexpr uint64_t hook_start_sound_immediate = 0x990dab38871d6d0f; //0x18275486
	constexpr uint64_t hook_set_bodygroup = 0xcfc09f1103185d72; //0x18275487
	constexpr uint64_t hook_modify_eye_pos = 0x491badaeb6fa665c; //0x18275484
	constexpr uint64_t hook_wnd_proc = 0x4ef9c358b8662f99; //0x18275485
	constexpr uint64_t hook_create_move = 0xcc6f95df263cb4af; //0x1827548A
	constexpr uint64_t hook_cl_move = 0xc63d7273239ee0ca; //0x1827548B
	constexpr uint64_t hook_frame_stage_notify = 0x6a7b1934448f74fb; //0x18275488
	constexpr uint64_t hook_on_latch_interp_var = 0xa90f00725fbc3bac; //0x18275489
	constexpr uint64_t hook_draw_model_execute = 0x9a3bc7b9ec1b8856; //0x1827548E
	constexpr uint64_t hook_render_view = 0x25f1228d5d09d142; //0x1827548F
	constexpr uint64_t hook_level_init_post_entity = 0x280c26b8b85b3fa3; //0x1827548C
	constexpr uint64_t hook_level_init_pre_entity = 0x729295c7b64439b2; //0x1827548D
	constexpr uint64_t hook_get_tonemap_settings_from_env_tonemap_controller = 0x3e932b8428405342;
	constexpr uint64_t hook_draw_3d_debug_overlays = 0x24070b2882df21fb; //0x18275573
	constexpr uint64_t hook_shader_api_draw_mesh = 0x77ee3a2f0f64a5e0; //0x18275570
	constexpr uint64_t hook_is_box_visible = 0xec50c1689d8d518f; //0x18275571
	constexpr uint64_t hook_scene_end = 0x8ae10242ce954707; //0x18275576
	constexpr uint64_t hook_calc_renderable_world_space_aabb_bloated = 0xab3a239a6964faec; //0x18275577
	constexpr uint64_t hook_add_renderables_to_render_lists = 0x90b230ca3ba11e54; //0x18275574
	constexpr uint64_t hook_do_post_screen_space_effects = 0x259621db7245d97c; //0x18275575
	constexpr uint64_t hook_present = 0x32811d6fe36918ad;
	constexpr uint64_t hook_reset = 0x870f7d4cd2ffb961;
	constexpr uint64_t hook_send_net_msg = 0xf6b85466cef64397; //0x18275578
	constexpr uint64_t hook_override_view = 0xd3812977c9dcb1f7; //0x18275579
	constexpr uint64_t hook_paint_traverse = 0xf041529edd84bab9; //0x1827557E
	constexpr uint64_t hook_find_material = 0xafce1a76c4010c5f; //0x1827557F
	constexpr uint64_t hook_emit_sound = 0x4218a1cef7b74da; //0x1827557C
	constexpr uint64_t hook_is_connected = 0xc79ed9aa13428e73; //0x1827557D
	constexpr uint64_t hook_lock_cursor = 0xfdbb17cf17e7313f; //0x18275562
	constexpr uint64_t hook_draw_set_color = 0xf375acda5d06ee03; //0x18275563
	constexpr uint64_t hook_test_hitboxes = 0xc9a81a4d67e259f1;
	constexpr uint64_t hook_setup_bones = 0x3586d0b0540b9eff; //0x18275561
	constexpr uint64_t hook_animating_setup_bones = 0x3d79f162c6eabe8c; //0x18275566
	constexpr uint64_t hook_post_data_update = 0x4a0670480f7fb3a8; //0x18275567
	constexpr uint64_t hook_maintain_sequence_transitions = 0x6141e72d20f02e29; //0x18275564
	constexpr uint64_t hook_trace_ray = 0x46bb51893b974a42; //0x18275565
	constexpr uint64_t hook_run_command = 0x7145f23f1a3f6c97; //0x1827556A
	constexpr uint64_t hook_process_movement = 0xfefadab0f433c289; //0x1827556B
	constexpr uint64_t hook_transfer_data = 0xde8067686f56043; //0x18275568
	constexpr uint64_t hook_perform_prediction = 0x6bf91d34bae9bff8; //0x18275569
	constexpr uint64_t hook_packet_start = 0xdbdac78dc810badf; //0x1827556E
	constexpr uint64_t hook_level_shutdown = 0x77d6660c6c5707ec; //0x1827556F
	constexpr uint64_t hook_physics_simulate = 0x3ece973186afe1cb; //0x1827556C
	constexpr uint64_t hook_estimate_abs_velocity = 0xf89f58d4881a7c76; //0x1827556D
	constexpr uint64_t hook_interpolate = 0x4ecc6f77dfd05f11;
	constexpr uint64_t hook_reset_latched = 0x8e0961461e25e9c6;
	constexpr uint64_t hook_send_weapon_anim = 0x61b4addfa319926e; //0x18275550
	constexpr uint64_t hook_fire_event = 0xbbbd323eadda62b0; //0x18275551
	constexpr uint64_t hook_do_animation_events = 0xfc32d9f36c9efded; //0x18275556
	constexpr uint64_t hook_deploy = 0x5614288d12593f60; //0x18275557
	constexpr uint64_t hook_get_fov = 0x8c6c10faf8c9d3d0; //0x18275554
	constexpr uint64_t hook_effects = 0x26c2c48f27d284e0; //0x18275555
	constexpr uint64_t hook_sequence = 0xda9e4d6e1fc250b4; //0x1827555A
	constexpr uint64_t hook_weapon_handle = 0x6a01b6121dbd3b9d; //0x1827555B
	constexpr uint64_t hook_simulation_time = 0x3097c47ad9af47ff; //0x18275558
	constexpr uint64_t hook_general_float = 0xe8b3d47dd75267f9; //0x18275559
	constexpr uint64_t hook_general_vec = 0x9ae68733dfabab56; //0x1827555E
	constexpr uint64_t hook_general_int = 0x1cb662d97f59f348; //0x1827555F
	constexpr uint64_t hook_general_bool = 0x18fcd8ded7e67496; //0x1827555C
	constexpr uint64_t hook_layer_sequence = 0x66b9b8cf128cd72e; //0x1827555D
	constexpr uint64_t hook_layer_cycle = 0x8e333820c849c48; //0x18275542
	constexpr uint64_t hook_layer_playback_rate = 0x6bb565641643e7c6; //0x18275543
	constexpr uint64_t hook_layer_weight = 0xacfc09ad85e26068; //0x18275540
	constexpr uint64_t hook_layer_weight_delta_rate = 0xa39a870d8922303e; //0x18275541
	constexpr uint64_t hook_layer_order = 0xdddec39131fd2a0b; //0x18275546
	constexpr uint64_t hook_convar_get_float_engine = 0x850b66607b67a6f1; //0x18275547
	constexpr uint64_t hook_convar_get_int_engine = 0x1129dabf0a427837; //0x18275544
	constexpr uint64_t hook_convar_get_int_client = 0x900f0dc43248f6d0; //0x18275545
	constexpr uint64_t hook_eye_position_and_vectors = 0x10542e161baf4879;
	constexpr uint64_t hook_obb_change_callback = 0x8a574e498759a28e; //0x1827554B
	constexpr uint64_t hook_server_cmd_key_values = 0x87e429ad2aa05da5; //0x18275548
	constexpr uint64_t hook_calc_view = 0xe19616d26bf8cb92; //0x18275549
	constexpr uint64_t hook_scale_mouse = 0x1f6a28524626d56; //0x1827554E
	constexpr uint64_t hook_convar_network_change_callback = 0x8a9ce871e18d32c9; //0x1827554F
	constexpr uint64_t hook_reevauluate_anim_lod = 0xfbf6d511deebc7bb; //0x1827554C
	constexpr uint64_t hook_start_sound = 0xce6828b31c0516d9; //0x1827554D
	constexpr uint64_t hook_update_clientside_anim = 0x9c162a2f63eadc1b; //0x18275532
	constexpr uint64_t hook_do_animation_events_animating = 0x90c4ca2c347ec3a7; //0x18275533
	constexpr uint64_t hook_get_default_fov = 0xeae8a53ae8085169; //0x18275530
	constexpr uint64_t hook_ent_info_list_link_before = 0xc0d164cea3004bd4; //0x18275531
	constexpr uint64_t hook_extract_occluded_renderables = 0x2658ec380eafa168; //0x18275536
	constexpr uint64_t hook_sv_msg_voicedata = 0x44212512945b80cd; //0x18275537
	constexpr uint64_t hook_hud_reticle_process_input = 0x5af1ebd655404f06; //0x18275534
