...
public:
	...
	__forceinline const data_t& GetLocalData() const { return m_data; }

	__forceinline std::unordered_map< unsigned long, data_t >& GetList() { return m_list; }
};

inline C_GrenadePrediction g_grenades_pred;