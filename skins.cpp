...
void Skins::think() {
	...
	if (!g_menu.main.skins.enable.get()) {
		if (m_glove) {
			m_glove->SetDestroyedOnRecreateEntities();
			m_glove->Release();
			m_glove = nullptr;
		}
		return;
	...
	for (int i{ 1 }; i <= g_csgo.m_entlist->GetHighestEntityIndex(); ++i) {
		...
		if (g_menu.main.skins.knife.get() > 0 && ent->is(HASH("CPredictedViewModel"))) {
			...
			case DEAGLE:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_deagle.get()) * 0.01f) + FLT_EPSILON;
				break;
			case ELITE:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_elite.get()) * 0.01f) + FLT_EPSILON;
				break;
			case FIVESEVEN:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_fiveseven.get()) * 0.01f) + FLT_EPSILON;
				break;
			case GLOCK:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_glock.get()) * 0.01f) + FLT_EPSILON;
				break;
			case AK47:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_ak47.get()) * 0.01f) + FLT_EPSILON;
				break;
			case AUG:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_aug.get()) * 0.01f) + FLT_EPSILON;
				break;
			case AWP:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_awp.get()) * 0.01f) + FLT_EPSILON;
				break;
			case FAMAS:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_famas.get()) * 0.01f) + FLT_EPSILON;
				break;
			case G3SG1:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_g3sg1.get()) * 0.01f) + FLT_EPSILON;
				break;
			case GALIL:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_galil.get()) * 0.01f) + FLT_EPSILON;
				break;
			case M249:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_m249.get()) * 0.01f) + FLT_EPSILON;
				break;
			case M4A4:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_m4a4.get()) * 0.01f) + FLT_EPSILON;
				break;
			case MAC10:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_mac10.get()) * 0.01f) + FLT_EPSILON;
				break;
			case P90:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_p90.get()) * 0.01f) + FLT_EPSILON;
				break;
			case UMP45:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_ump45.get()) * 0.01f) + FLT_EPSILON;
				break;
			case XM1014:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_xm1014.get()) * 0.01f) + FLT_EPSILON;
				break;
			case BIZON:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_bizon.get()) * 0.01f) + FLT_EPSILON;
				break;
			case MAG7:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_mag7.get()) * 0.01f) + FLT_EPSILON;
				break;
			case NEGEV:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_negev.get()) * 0.01f) + FLT_EPSILON;
				break;
			case SAWEDOFF:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_sawedoff.get()) * 0.01f) + FLT_EPSILON;
				break;
			case TEC9:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_tec9.get()) * 0.01f) + FLT_EPSILON;
				break;
			case P2000:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_p2000.get()) * 0.01f) + FLT_EPSILON;
				break;
			case MP7:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_mp7.get()) * 0.01f) + FLT_EPSILON;
				break;
			case MP9:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_mp9.get()) * 0.01f) + FLT_EPSILON;
				break;
			case NOVA:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_nova.get()) * 0.01f) + FLT_EPSILON;
				break;
			case P250:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_p250.get()) * 0.01f) + FLT_EPSILON;
				break;
			case SCAR20:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_scar20.get()) * 0.01f) + FLT_EPSILON;
				break;
			case SG553:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_sg553.get()) * 0.01f) + FLT_EPSILON;
				break;
			case SSG08:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_ssg08.get()) * 0.01f) + FLT_EPSILON;
				break;
			case M4A1S:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_m4a1s.get()) * 0.01f) + FLT_EPSILON;
				break;
			case USPS:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_usps.get()) * 0.01f) + FLT_EPSILON;
				break;
			case CZ75A:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_cz75a.get()) * 0.01f) + FLT_EPSILON;
				break;
			case REVOLVER:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_revolver.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_BAYONET:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_bayonet.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_FLIP:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_flip.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_GUT:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_gut.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_KARAMBIT:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_karambit.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_M9_BAYONET:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_m9.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_HUNTSMAN:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_huntsman.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_FALCHION:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_falchion.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_BOWIE:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_bowie.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_BUTTERFLY:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_butterfly.get()) * 0.01f) + FLT_EPSILON;
				break;
			case KNIFE_SHADOW_DAGGERS:
				...
				weapon->m_flFallbackWear() = ((100.f - g_menu.main.skins.quality_daggers.get()) * 0.01f) + FLT_EPSILON;
				break;
	...
	if (g_menu.main.skins.glove.get() > 0) {
		...
		m_glove = g_csgo.m_entlist->GetClientEntityFromHandle< Weapon* >(wearables[0]);
		...
		if (!m_glove) {
			...
			m_glove = g_csgo.m_entlist->GetClientEntity< Weapon* >(index);
		...
		m_glove->m_iAccountID() = info.m_xuid_low;

		// set custom data.
		m_glove->m_nFallbackPaintKit() = 10000 + g_menu.main.skins.glove_id.get();
		m_glove->m_iItemDefinitionIndex() = data->m_id;
		m_glove->SetGloveModelIndex(data->m_model_index);

		// update the glove.
		m_glove->PreDataUpdate(DATA_UPDATE_CREATED);
	}
...
void Skins::UpdateAnimations(Entity* ent) {
	...
	int seq = ent->m_nSequenceViewmodel();
