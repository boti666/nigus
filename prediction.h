...
public:
	...
	__forceinline bool& m_bPreviousAckHadErrors()
	{
	...
	__forceinline int CheckMovingGround(Player* player, double unk) {
		return util::get_method< int(__thiscall*)(decltype(this), Player*, double) >(this, 18)(this, player, unk);
	}
...
public:
	...
	__forceinline Player*& m_Player() {
		return *(Player**)((DWORD)(this) + 0x4);
	}
