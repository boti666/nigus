...
namespace render {
	...
	extern Font console;
	extern Font verdana;
	extern Font verdana_pixel;
	extern Font verdana_pixel_bold;
	extern Font tahoma;
	extern Font tahoma_pixel;
	extern Font smallest_pixel_7;
	extern Font small_fonts;
	extern Font px_04b03;
	extern Font manual_antiaim;
	extern Font arrows;
	extern Font amogus;
	...
	void DrawSemiTransparentBlackBackground(int x, int y, int w, int h, float alpha);
	void flatSphere(vec3_t origin, float radius, float angle, float scale, Color color);
}
