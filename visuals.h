...
public:
	...
	void DmgIndicator();
	void NoSmoke( );
	bool ForceDormant(Player* pPlayer);
	void think( );
	void Spectators( );
	...
	void DrawHitboxMatrix(LagRecord* record, float time);
	void OverrideMaterial(bool ignoreZ, bool use_env, Color& color, IMaterial* material);
