...
public:
	...
	__forceinline bool IsLoopback() {
		return util::get_method< bool(__thiscall*)(decltype(this)) >(this, ISLOOPBACK)(this);
	}
...
public:
	...
	__forceinline bool IsDrawingLoadingImage() {
		return util::get_method< bool(__thiscall*)(decltype(this)) >(this, 28)(this);
	}
