...
public:
	...
	Color LerpRGB(Color two, float t)
	{
		return Color
		(
			r() + (two.r() - r()) * t,
...
namespace colors {
	...
	static Color gray{ 210, 210, 210, 210 };
	...
	static Color transparent_orange{ 235, 165, 68, 200 };
	static Color transparent_white{ 255, 255, 255, 179 };
}